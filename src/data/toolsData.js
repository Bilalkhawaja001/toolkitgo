...
const rawTools = [
  ...
  { id: 'receipt-generator', name: 'Receipt Generator', description: 'Create A4 payment receipts in your browser and download them as PDF.', category: 'business-tools', icon: 'Receipt', popular: true },
  { id: 'quotation-generator', name: 'Quotation Generator', description: 'Build itemized quotations with auto totals and export A4 PDF in your browser.', category: 'business-tools', icon: 'FileText', popular: false },
  { id: 'salary-slip-generator', name: 'Salary Slip Generator', description: 'Generate payroll-style salary slips with net pay and export A4 PDF in your browser.', category: 'business-tools', icon: 'DollarSign', popular: false },
  { id: 'purchase-order-generator', name: 'Purchase Order Generator', description: 'Create itemized purchase orders with auto totals and export A4 PDF in your browser.', category: 'business-tools', icon: 'ShoppingCart', popular: false },
