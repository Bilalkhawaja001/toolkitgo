...
const rawTools = [
  ...
  { id: 'invoice-generator', name: 'Invoice Generator', description: 'Planned professional invoice UI.', category: 'business-tools', icon: 'FileText', popular: true },
  ...
  { id: 'emi-calculator', name: 'EMI Calculator', description: 'Planned loan installment calculator UI.', category: 'calculator-tools', icon: 'CreditCard', popular: true },
  { id: 'gst-calculator', name: 'GST Calculator', description: 'Planned GST calculator UI.', category: 'calculator-tools', icon: 'Percent', popular: true },
  { id: 'bmi-calculator', name: 'BMI Calculator', description: 'Planned BMI calculator UI.', category: 'calculator-tools', icon: 'Heart', popular: true },
  { id: 'age-calculator', name: 'Age Calculator', description: 'Planned age calculator UI.', category: 'calculator-tools', icon: 'Calendar', popular: false },
  { id: 'percentage-calculator', name: 'Percentage Calculator', description: 'Planned percentage calculator UI.', category: 'calculator-tools', icon: 'Percent', popular: false },
  { id: 'unit-converter', name: 'Unit Converter', description: 'Planned unit converter UI.', category: 'calculator-tools', icon: 'Scale', popular: false },
  { id: 'date-calculator', name: 'Date Calculator', description: 'Planned date calculator UI.', category: 'calculator-tools', icon: 'CalendarDays', popular: false },

  { id: 'json-formatter', name: 'JSON Formatter', description: 'Planned JSON formatter UI.', category: 'developer-tools', icon: 'Braces', popular: true },
  { id: 'base64-encoder', name: 'Base64 Encoder/Decoder', description: 'Planned Base64 utility UI.', category: 'developer-tools', icon: 'Code', popular: true },
  { id: 'url-encoder', name: 'URL Encoder/Decoder', description: 'Planned URL encoding utility UI.', category: 'developer-tools', icon: 'Globe', popular: false },
  { id: 'html-encoder', name: 'HTML Encoder/Decoder', description: 'Planned HTML entity utility UI.', category: 'developer-tools', icon: 'FileCode', popular: false },
  { id: 'css-minifier', name: 'CSS Minifier', description: 'Planned CSS minifier UI.', category: 'developer-tools', icon: 'Palette', popular: false },
  { id: 'js-minifier', name: 'JS Minifier', description: 'Planned JavaScript minifier UI.', category: 'developer-tools', icon: 'Terminal', popular: false },
  { id: 'password-generator', name: 'Password Generator', description: 'Planned password generator UI.', category: 'developer-tools', icon: 'Lock', popular: true },
  { id: 'lorem-ipsum', name: 'Lorem Ipsum Generator', description: 'Planned placeholder text generator UI.', category: 'developer-tools', icon: 'Type', popular: false },
  ...
  { id: 'wifi-qr-generator', name: 'WiFi QR Generator', description: 'Planned WiFi QR utility UI.', category: 'qr-tools', icon: 'Wifi', popular: false },
  { id: 'whatsapp-qr-generator', name: 'WhatsApp QR Generator', description: 'Planned WhatsApp QR utility UI.', category: 'qr-tools', icon: 'MessageCircle', popular: false },
  { id: 'barcode-generator', name: 'Barcode Generator', description: 'Planned barcode generator UI.', category: 'qr-tools', icon: 'Barcode', popular: true },
  { id: 'vcard-qr-generator', name: 'vCard QR Generator', description: 'Planned vCard QR utility UI.', category: 'qr-tools', icon: 'Contact', popular: false },
  ...
  { id: 'redact-pdf', name: 'Redact PDF', description: 'Safe redaction workflow note with rasterized-output limitation.', category: 'pdf-tools', icon: 'Eraser', popular: false },
